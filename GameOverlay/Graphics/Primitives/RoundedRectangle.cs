namespace GameOverlay.Graphics.Primitives
{
    ...
    public struct RoundedRectangle
    {
        ...
        {
            return "{Rectangle= " + Rectangle + ", RadiusX= " + RadiusX + ", RadiusY= " + RadiusY + "}";
        }
        ...
        /// <summary>
        ///     Performs an implicit conversion from <see cref="RoundedRectangle" /> to
        ///     <see cref="SharpDX.Direct2D1.RoundedRectangle" />.
        /// </summary>
        /// <param name="rectangle">The rectangle.</param>
        /// <returns>
